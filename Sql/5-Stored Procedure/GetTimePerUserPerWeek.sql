IF OBJECT_ID('[ed].[GetTimePerUserPerWeek]','P') IS NULL
	EXEC('CREATE PROCEDURE [ed].[GetTimePerUserPerWeek] WITH ENCRYPTION AS BEGIN SELECT NULL; END;');
GO
ALTER PROCEDURE [ed].[GetTimePerUserPerWeek]
